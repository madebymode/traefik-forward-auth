...
type Config struct {
	...
	RedirectDomains        CommaSeparatedList   `long:"redirect-domain" env:"REDIRECT_DOMAIN" env-delim:"," description:"Allow absolute redirects to hosts matching these domains, can be set multiple times"`
